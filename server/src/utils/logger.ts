...
export const logInfo = (event: string, meta: Record<string, unknown> = {}): void => {
  emitLog({ ...basePayload("info", event), ...meta });
};

export const logWarn = (event: string, meta: Record<string, unknown> = {}): void => {
  emitLog({ ...basePayload("warn", event), ...meta });
};

export const logError = (event: string, meta: Record<string, unknown> = {}): void => {
